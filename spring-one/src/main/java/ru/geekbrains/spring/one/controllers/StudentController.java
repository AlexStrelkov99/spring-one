...
//    }
    ...
    @GetMapping("/students/decrease_scores/{id}")
    public String decreaseScores(@PathVariable Long id) {
        studentService.decreaseScores(id);
        return "redirect:/";
    }
    @GetMapping("/students/increase_scores/{id}")
    public String increaseScores(@PathVariable Long id) {
        studentService.increaseScores(id);
        return "redirect:/";
    }
}
